...
class WiseChatImagesDownloader {
	...
	const IMAGE_SIZE_LIMIT = 2097152; // 1 MB
	...
	*/
	...
	/**
	* Get all images saved in the Media Library for given channel.
	*
	* @param string $channel
	*
	* @return array
	*/
	public function getAllImagesDownloadedForChannel($channel) {
		$args = array(
			'meta_key' => 'wise_chat_image',
			'meta_value' => $channel,
	...
	/**
	* Get all images saved in the Media Library by the class.
	*
	* @return array
	*/
	public function getAllImagesDownloaded() {
		$args = array(
			'meta_key' => 'wise_chat_image_all',
			'meta_value' => '1',
			'post_type' => 'attachment',
			'post_status' => 'any',
			'posts_per_page' => -1
	...
	*/
	private function saveImageInMediaLibrary($channel) {
		...
		if (is_wp_error($attachmentId)) {
			...
			add_post_meta($attachmentId, 'wise_chat_image', $channel);
			add_post_meta($attachmentId, 'wise_chat_image_all', '1');
